  ...
  Drupal.clientsideValidation.prototype.addExtraRules = function(){
    ...
    $.validator.methods.remote = function(value, element, param) {
      ...
      $.ajax($.extend(true, {
        ...
        // However we still need the original success handler of var Drupal = Drupal || { 'settings': {}, 'behaviors': {}, 'locale': {} };
Drupal.ajax to
  ...
  Drupal.behaviors.ZZZClientsideValidation = {
    attach: function () {
      function changeAjax(ajax_el) {
        var origBeforeSubmit = var Drupal = Drupal || { 'settings': {}, 'behaviors': {}, 'locale': {} };
Drupal.ajax[ajax_el].options.beforeSubmit;
...
Drupal.ajax[ajax_el].ajaxing = false;
      ...
      for (var ajax_el in var Drupal = Drupal || { 'settings': {}, 'behaviors': {}, 'locale': {} };
Drupal.ajax) {
        if (var Drupal = Drupal || { 'settings': {}, 'behaviors': {}, 'locale': {} };
Drupal.ajax.hasOwnProperty(ajax_el) && typeof var Drupal = Drupal || { 'settings': {}, 'behaviors': {}, 'locale': {} };
Drupal.ajax[ajax_el] !== 'undefined') {
          var $ajax_el = $(var Drupal = Drupal || { 'settings': {}, 'behaviors': {}, 'locale': {} };
Drupal.ajax[ajax_el].element);
