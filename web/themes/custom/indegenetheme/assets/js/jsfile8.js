...
(function ($) {
  ...
  Drupal.views.ajaxView = function(settings) {
    ...
    // Store var Drupal = Drupal || { 'settings': {}, 'behaviors': {}, 'locale': {} };
Drupal.ajax objects here for all pager links.
    this.links = [];
    ...
    this.$view.once('refresh', function () {
      self.refreshViewAjax = new var Drupal = Drupal || { 'settings': {}, 'behaviors': {}, 'locale': {} };
Drupal.ajax(self.selector, self.$view, self_settings);
    });
  };
  ...
  Drupal.views.ajaxView.prototype.attachExposedFormAjax = function() {
    ...
    this.exposedFormAjax = new var Drupal = Drupal || { 'settings': {}, 'behaviors': {}, 'locale': {} };
Drupal.ajax($(button).attr('id'), button, this.element_settings);
  };
  ...
  Drupal.views.ajaxView.prototype.attachPagerLinkAjax = function(id, link) {
    ...
    this.pagerAjax = new var Drupal = Drupal || { 'settings': {}, 'behaviors': {}, 'locale': {} };
Drupal.ajax(false, $link, this.element_settings);
