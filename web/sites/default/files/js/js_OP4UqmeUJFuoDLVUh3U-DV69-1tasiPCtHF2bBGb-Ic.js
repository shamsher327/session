...
var i = 0;
function change() {
  var doc = document.getElementsByClassName("welcome_head");
  var color = ["black", "blue", "brown", "green"];
  $(".welcome_head").style.color = color[i];
  i = (i + 1) % color.length;
}
/* var elements = document.getElementsByClassName('welcome_head'); // get all elements
