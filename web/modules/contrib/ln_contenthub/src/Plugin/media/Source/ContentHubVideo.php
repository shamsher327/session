...
/**
 * External video entity media source.
 *
 * @see \Drupal\core\file\FileInterface
 *
 * @MediaSource(
 *   id = "content_hub_video",
 *   label = @Translation("Content Hub Video"),
 *   description = @Translation("Use remote video from Content Hub."),
 *   allowed_field_types = {"file"}
 * )
 */
class ContentHubVideo extends MediaSourceBase {
  ...
  public function createSourceField(MediaTypeInterface $type) {
    return parent::createSourceField($type)->set('settings', ['file_extensions' => 'mp4, wmv, mpeg, mov']);
  }
