...
namespace Drupal\dsu_c_sharebuttons\EventSubscriber;
 ...
 */
class DSUShareButtonsSubscriber implements EventSubscriberInterface {
  ...
  public function addMoreSocialMedia($event) {
    ...
    $element['tumblr'] = 'Tumblr';
    $element['pinterest'] = 'Pinterest';
