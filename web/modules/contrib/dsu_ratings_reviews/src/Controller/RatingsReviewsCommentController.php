...
class RatingsReviewsCommentController extends CommentController {
  ...
  public function replyFormAccess(EntityInterface $entity, $field_name, $pid = NULL) {
    ...
    if ($pid) {
      ...
      if ($comment->getTypeId() === RatingsReviewsDisplayAdapter::COMMENT_TYPE) {
        ...
        $access = $access->andIf(AccessResult::allowedIfHasPermission($this->currentUser(), RatingsReviewsDisplayAdapter::REPLY_PERMISSION));
