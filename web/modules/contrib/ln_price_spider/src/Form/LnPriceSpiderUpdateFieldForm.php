...
class LnPriceSpiderUpdateFieldForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['file_upload'] = [
      ...
      '#description'       => $this->t('Upload CSV file for importing PriceSpider ID with respective nodes. Get a sample CSV file from below link<p><a target="_blank" href="/modules/contrib/ln_price_spider/migrations/pricespider_example/price_spider_by_nid.csv">Download a CSV file example</a></p>'),
      '#upload_validators' => [
