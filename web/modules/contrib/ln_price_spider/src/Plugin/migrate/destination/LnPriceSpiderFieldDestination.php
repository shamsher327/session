...
namespace Drupal\ln_price_spider\Plugin\migrate\destination;
...
/**
 * @MigrateDestination(
 *   id = "ln_price_spider_field_destination"
 * )
 */
class LnPriceSpiderFieldDestination extends EntityContentBase {
   ...
   * \Drupal\ln_price_spider\Plugin\migrate\destination\LnPriceSpiderFieldDestination|
