...
jQuery UI Spinner library for any themes and modules that require it.

  - jQuery UI [Spinner documentation](https://jqueryui.com/spinner/)
  - jQuery UI [Spinner API documentation](https://api.jqueryui.com/spinner/)
...
2.  Change any references in your theme or module from
    `core/jquery.ui.spinner` to `jquery_ui_spinner/spinner`
