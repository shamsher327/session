...
/**
 * Class IndegeneCustomForm.
 *
 * @package Drupal\indegenecustom\Form
 */
class IndegeneCustomForm extends FormBase
{
    /**
     * {@inheritdoc}
     */
    ...
    public function buildForm(array $form, FormStateInterface $form_state)
    {
        ...
        $record = array();
        if (isset($_GET['num'])) {
            $query = $conn->select('indegenecustom', 'm')
